...
def draw_flip_up_down(draw):
    draw.line([(5, 18), (20, 18)], fill='black', width=2)
    draw.polygon([(8, 10), (12, 15), (16, 10)], fill='red')

def draw_faster(draw):
    draw.polygon([(5, 8), (10, 12), (5, 16)], fill='black')
    draw.polygon([(8, 8), (13, 12), (8, 16)], fill='red')
    draw.polygon([(11, 8), (16, 12), (11, 16)], fill='black')

def draw_slower(draw):
    draw.polygon([(20, 8), (15, 12), (20, 16)], fill='red')
    draw.polygon([(17, 8), (12, 12), (17, 16)], fill='black')
    draw.polygon([(14, 8), (9, 12), (14, 16)], fill='red')

def draw_reverse_playback(draw):
    draw.polygon([(20, 5), (20, 20), (8, 12)], outline='red', width=2)

def draw_reset_button(draw):
    draw.ellipse([(5, 5), (20, 20)], outline='black', width=2)
    draw.ellipse([(10, 10), (15, 15)], fill='green')

def draw_mirror_up(draw):
    draw.line([(5, 12), (20, 12)], fill='black', width=2)
    draw.polygon([(12, 7), (9, 12), (15, 12)], fill='red')

def draw_mirror_down(draw):
    draw.line([(5, 12), (20, 12)], fill='black', width=2)
    draw.polygon([(12, 17), (9, 12), (15, 12)], fill='red')
...
def main():
    icons = [
        ...
        (draw_flip_up_down, 'flip_up_down.png'),
        (draw_faster, 'faster.png'),
        (draw_slower, 'slower.png'),
        (draw_reverse_playback, 'reverse_playback.png'),
        (draw_reset_button, 'reset_button.png'),
        (draw_mirror_up, 'mirror_up.png'),
        (draw_mirror_down, 'mirror_down.png'),
    ]
